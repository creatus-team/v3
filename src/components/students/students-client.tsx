                      ...
                      {student.currentSession && (
                        <div>
                          ...
                          <div className="grid grid-cols-2 gap-2 text-sm">
                            ...
                            <div>
                              <span className="text-slate-500">종료일:</span> {student.currentSession.end_date}
                              ...
                              {(() => {
                                ...
                                return nextSession ? (
                                  <span className="ml-2 text-green-600 text-xs">(재결제 완료: {nextSession.end_date}까지)</span>
                                ) : null;
                              })()}
                            </div>
                            <div><span className="text-slate-500">회차:</span> {student.extensionCount}회차</div>
